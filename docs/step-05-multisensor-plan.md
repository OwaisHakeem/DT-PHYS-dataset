...
timestamp\_ms,phase,label,gsr,ecg\_raw,emg\_raw,airflow\_raw,spo2,pulse,temp\_c,body\_pos
phase: baseline | task | recovery
label: optional (e.g., self\_report\_0\_10 or task\_id)
...
3. Recovery: 2 min seated rest
   ...
   • Add arduino/step05\_multisensor\_scaffold/step05\_multisensor\_scaffold.ino
