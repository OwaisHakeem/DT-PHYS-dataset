...
e-Health Sensor Platform v2.0 (Cooking Hacks / Libelium)
...
Connected the Arduino Uno to the computer via USB cable.

Confirmed Arduino Uno detection in the operating system (COM port identification).
